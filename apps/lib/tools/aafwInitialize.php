...
<?php  }
  ...
  public static function doService ( $argv ){
    ...
    if ( !is_file ( AAFW::$AAFW_ROOT . '/plugins/action/DefaultModelSetter.php' ) ) file_put_contents ( AAFW::$AAFW_ROOT . '/plugins/controller/DefaultModelSetter.php', self::getDefaultModelSetter()  );
  }
...
class DefaultModelSetter extends aafwActionPluginBase {
  ...
  public function doService(){
    foreach ( $this->Action->getModelDefinitions() as $class ) {
      $this->Action->setModel ( aafwEntityStoreFactory::create ( $class ) );
    }
...
require_once "aafwController.php";
try{
